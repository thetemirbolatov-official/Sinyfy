...
Из исходников
```bash
git clone https://github.com/thetemirbolatov/sinyfy.git
cd sinyfy
```
```bash
pip install -e .
...
sinyfy https://example.com -o my_site
```
```bash
# Без скачивания изображений
sinyfy https://example.com --no-images
```
...
⚠️ Предупреждение
Инструмент предназначен только для законного использования. Убедитесь, что у вас есть права на клонирование сайта, особенно если он защищен авторским правом или содержит конфиденциальную информацию.
